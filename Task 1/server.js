...
route.for("GET","js/main.js", function(request,response){
	serverStatic(response,"js/main.js");
});


route.for("GET","/", function(request,response){
	serverStatic(response,"public/game1.html");
});
...
console.log("Server has started...abc");
